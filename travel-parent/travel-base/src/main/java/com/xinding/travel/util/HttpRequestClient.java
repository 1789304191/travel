...
public class HttpRequestClient {
	...
	public static void main(String[] args) throws Exception {
		...
		String param = "scheduleId=8&type=1&userId=37&num=1";
		String result = client.sendPost("http://211.144.107.201:9090/museum/app/museum/book/preorder", param);
		// String result =
		// client.sendGet("http://211.144.107.201:9090/museum/api/museum/schedule",
		// "start=0&pagesize=10&sortorder=desc&sortfield=s.id");
