...
(function () {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
            ...
            .state('app.user_table', {
                url: '/user_table',
                title: '会员列表',
                templateUrl: helper.basepath('user-table.html'),
                controller: 'UserTableCtrl',
                resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')

            })
            .state('app.role_permissions', {
                url: '/role_permissions',
                title: '系统权限',
                templateUrl: helper.basepath('role-permissions.html'),
                controller: 'RolePermissionsCtrl',
                resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')

            })
             .state('app.admin-area', {
                url: '/admin-area',
                title: '行政区域',
                templateUrl: helper.basepath('adminArea/admin-area.html'),
                controller: 'adminAreaCtrl',
                resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')

            })
            .state('app.role_table', {
                url: '/role_table',
                title: '角色管理',
                templateUrl: helper.basepath('role-table.html'),
                controller: 'RoleTableCtrl',
                resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            ...
            .state('app.customer-user', {
            	url: '/customer-user',
            	title: '驻户用户',
            	templateUrl: helper.basepath('customer-user.html'),
            	controller: 'CustomerUserCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            	
            })
            .state('app.scenic-project', {
            	url: '/scenic-project',
            	title: '景点项目',
            	templateUrl: helper.basepath('scenic/scenic-project.html'),
            	controller: 'ScenicProjectCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert','cheditor')
            ...
            .state('app.pdauser', {
            	url: '/pdauser',
            	title: 'PDA用户管理',
            	templateUrl: helper.basepath('pda/pdauser.html'),
            	controller: 'PdauserCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            ...
            .state('app.pdadevice', {
            	url: '/pdadevice',
            	title: 'PDA设备管理',
            	templateUrl: helper.basepath('pda/pdadevice.html'),
            	controller: 'PdadeviceCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            	
            })
            .state('app.compayBillType', {
            	url: '/compayBillType',
            	title: '企业类型票据',
            	templateUrl: helper.basepath('billType/compayBillType.html'),
            	controller: 'CompayBillTypeCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            	
            })
            .state('app.personalBillType', {
            	url: '/personalBillType',
            	title: '个人类型票据',
            	templateUrl: helper.basepath('billType/personalBillType.html'),
            	controller: 'PersonalBillTypeCtrl',
            	resolve:  helper.resolveFor('ngDialog','oitozero.ngSweetAlert')
            	
            })
            .state('app.user-statistics', {
            	url: '/user-statistics',
            	title: '个人类型票据',
            	templateUrl: helper.basepath('userStatistics/user-statistics.html'),
