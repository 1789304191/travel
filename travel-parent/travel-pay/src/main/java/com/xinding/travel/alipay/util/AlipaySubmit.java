package com.xinding.travel.alipay.util;
...
import com.xinding.travel.alipay.sign.RSA;
import com.xinding.travel.controller.WeixinController;
...
public class AlipaySubmit {
	private static Logger log = Logger.getLogger(AlipaySubmit.class);
	/**
