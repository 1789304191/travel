...
public class PropertiesVo {
	...
	private String spot_picture_url;
	...
	public void setEvent_picture_url(String event_picture_url) {
		this.event_picture_url = event_picture_url;
	}
	public String getSpot_picture_url() {
		return spot_picture_url;
	}
	public void setSpot_picture_url(String spot_picture_url) {
		this.spot_picture_url = spot_picture_url;
	}
